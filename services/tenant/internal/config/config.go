...
// (Tenant doesn't dial any other service, so it does not consume
// cfg.MTLSClientCreds — but staying consistent with the other 10
// services makes future additions trivial.)
type Config struct {
