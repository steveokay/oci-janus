...
- **FUT-017** — Scan-on-cached-images: new "Scans" tab on the FUT-016 detail page + severity column on the cache table + per-upstream auto-scan policy editor on the cache page header (filed 2026-06-24)
